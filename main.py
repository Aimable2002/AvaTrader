...
class TradingBot:
            ...
            for symbol in symbols:
                try:
                    ...
                    if price_movement == "UP" and change_percent > 0.1 :
                        signal = "SELL"  # BUY when price is expected to rise
                        ...
                        signal = "BUY"   # SELL when price is expected to fall
    ...
    def run(self):
        ...
        try:
            ...
            # if not mt5.initialize(path="C:\\Program Files\\Octa Markets MetaTrader 5\\terminal64.exe"):
